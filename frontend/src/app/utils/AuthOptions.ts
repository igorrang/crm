            ...
            async authorize(credentials: any, req: any) {
                ...
                if (credentials.provider === UserProvider.EMAIL_PASSWORD) {
                    ...
                    try{
                        ...
                        if(!user){
                            const createUserDtoFromGoogle: CreateUserDtoFromGoogle = {name: payload?.given_name as string, surname: payload?.family_name as string, email: payload?.email as string, confirmEmail: payload?.email as string, provider: UserProvider.GOOGLE_AUTH }
